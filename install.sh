...
client_port_start="$(read_default "CLIENT_PORT_START" "51043")"
...
reset_reality_keys="$(read_bool "RESET_REALITY_KEYS" "true")"
reset_client_uuids="$(read_bool "RESET_CLIENT_UUIDS" "true")"
